...
function createTicketCard(data) {
    const isResolved = data.status === 'resolved' || data.status === 'replied'; // treat replied as resolved for user view
        ...
        <div class="bg-gray-50 dark:bg-gray-700/20 border border-gray-100 dark:border-gray-700 rounded-xl p-5">
            <div class="flex justify-between items-start mb-3">
                <div class="flex items-center gap-3">
                     <div class="w-10 h-10 rounded-full ${isResolved ? 'bg-green-100 text-green-600' : 'bg-blue-100 text-blue-600'} flex items-center justify-center font-bold text-sm">
